(() => {
  "use strict";
  const e = {},
    t = document.querySelector(".lang");
  t &&
    t.querySelector(".lang__btn").addEventListener("click", () => {
      t.classList.toggle("lang_open");
    });
  let s = !0,
    i = (e = 500) => {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              O = e.isHorizontal() ? E(r, "width", !0) : E(r, "height", !0);
            else {
              const e = t(n, "width"),
                s = t(n, "padding-left"),
                i = t(n, "padding-right"),
            ...
            (O = (n - (s.slidesPerView - 1) * T) / s.slidesPerView),
              s.roundLengths && (O = Math.floor(O)),
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ? n < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (n = e.getSlideIndex(
                  b(s, `${a}[data-swiper-slide-index="${r}"]`)[0],
                )),
                u(() => {
                  e.slideTo(n);
                }))
  ...
  function F(e) {
    ...
    if ("touchstart" === i.type) return void $(t, i, i.targetTouches[0].pageX);
  ...
  function H(e) {
    ...
    const p = l.pageX,
      u = l.pageY;
    if (c.preventedByNestedSwiper) return (n.startX = p), void (n.startY = u);
    if (!s.allowTouchMove)
      return (
  ...
  class te {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = x(b(t, `.${s.slideClass}, swiper-slide`)[0]);
      return x(e) - i;
    }
