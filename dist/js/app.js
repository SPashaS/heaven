(() => {
          ...
          void 0 !== n &&
            ...
            (m(e[i]) && m(r[i])
              ? r[i].__swiper__
                ...
                : f(e[i], r[i])
              : !m(e[i]) && m(r[i])
                ? ((e[i] = {}), r[i].__swiper__ ? (e[i] = r[i]) : f(e[i], r[i]))
                : (e[i] = r[i]));
        }
      }
    }
  ...
  var z = {
    ...
    updateSlides: function () {
      ...
      const s = e.params,
        ...
        c = w(r, `.${e.params.slideClass}, swiper-slide`),
      ...
      "string" == typeof y && y.indexOf("%") >= 0
        ...
        s.centeredSlides &&
          s.cssMode &&
          (v(i, "--swiper-centered-offset-before", ""),
          v(i, "--swiper-centered-offset-after", ""));
      ...
      for (let i = 0; i < p; i += 1) {
        ...
        if (
          ((O = 0),
          c[i] && (r = c[i]),
          M && e.grid.updateSlide(i, r, c),
          !c[i] || "none" !== T(r, "display"))
        ) {
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              O = e.isHorizontal() ? x(r, "width", !0) : x(r, "height", !0);
            else {
              const e = t(n, "width"),
                s = t(n, "padding-left"),
                i = t(n, "padding-right"),
            ...
            (O = (n - (s.slidesPerView - 1) * y) / s.slidesPerView),
              s.roundLengths && (O = Math.floor(O)),
              c[i] && (c[i].style[e.getDirectionLabel("width")] = `${O}px`);
          c[i] && (c[i].swiperSlideSize = O),
            m.push(O),
            s.centeredSlides
              ? ((E = E + O / 2 + C / 2 + y),
                0 === C && 0 !== i && (E = E - n / 2 - y),
      ...
      if (
        ...
        M && e.grid.updateWrapperSize(O, u),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (
        ...
        v(i, "--swiper-centered-offset-before", -u[0] + "px"),
          v(
            i,
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!n.support.smoothScroll)
            return (
              g({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, r) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              g({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  var B = {
    ...
    loopFix: function (e) {
      ...
      const M = w ? Math.ceil(d.length / h.grid.rows) : d.length,
        O = (w ? d[n].column : n) + (m && void 0 === r ? -f / 2 + 0.5 : 0);
      if (O < g) {
        C = Math.max(g - O, v);
  ...
  function $(e) {
    ...
    p && i.target && i.target.shadowRoot && h && (d = h[0]);
    ...
    d.matches(r.focusableElements) &&
      ((w = !1), "SELECT" === d.nodeName && (r.isTouched = !1)),
      s.activeElement &&
  ...
  function F(e) {
    ...
    const p = d.pageX,
      h = d.pageY;
    if (c.preventedByNestedSwiper) return (n.startX = p), void (n.startY = h);
    if (!s.allowTouchMove)
      return (
        c.target.matches(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
          (Object.assign(n, { startX: p, startY: h, currentX: p, currentY: h }),
          (i.touchStartTime = u()))
        )
      );
  ...
  function H(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? (f || (m >= l[e] && m < l[e + t])) && ((v = e), (g = l[e + t] - l[e]))
        : (f || m >= l[e]) &&
          ((v = e), (g = l[l.length - 1] - l[l.length - 2]));
    }
    let w = null,
      b = null;
    n.rewind &&
    ...
    if (h > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (S >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? w : v + T)
          : t.slideTo(v)),
        "prev" === t.swipeDirection &&
          (S > 1 - n.longSwipesRatio
            ? t.slideTo(v + T)
            : null !== b && S < 0 && Math.abs(S) > n.longSwipesRatio
              ? t.slideTo(b)
              : t.slideTo(v));
    } else {
      ...
      (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
        ? r.target === t.navigation.nextEl
          ? t.slideTo(v + T)
          : t.slideTo(v)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : v + T),
  ...
  class ee {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = y(w(t, `.${s.slideClass}, swiper-slide`)[0]);
      return y(e) - i;
    }
        ...
        document.querySelector(".promo__swiper") &&
          new ee(".promo__slider", {
            ...
            breakpoints: {
              ...
              1268: { slidesPerView: "auto", spaceBetween: 40 },
            },
            on: {},
          }),
        document.querySelector(".examples__swiper") &&
          new ee(".examples__slider", {
            modules: [te],
            observer: !0,
            observeParents: !0,
            slidesPerView: "auto",
